...
### 🚀 Who are we?
[Google Developer Student Club, Aditya Engineering College](https://gdscaec.org/) is a Google Developers program for university students to learn programming skills. The club is open to any student, ranging from novice developers who are just starting, to advanced developers who want to further their skills.
...
### 👀 What we do?
GDSC AEC Surampalem has organised a number of workshops, fun events and meetups with students in and around AEC Surampalem to promote learning and developer skills among themselves. 
